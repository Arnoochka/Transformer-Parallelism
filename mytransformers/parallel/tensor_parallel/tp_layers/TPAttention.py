...
class TPGroupedAttentionCore(TPModule):
    def __init__(self,
                 config,
                 out_proj: TPModule,
...
class TPAttentionKVCore(TPModule):
    def __init__(self,
                 config,
                 out_proj: TPModule,
        ...
        self.attention = TPGroupedAttentionCore(config,
                                                       out_proj,
                                                       tp_group)
...
class TPAttention(TPAttentionKVCore):
    def __init__(self,
                 config,
                 query: TPModule,
                 key: TPModule,
...
class TPCrossAttention(TPAttention):

...
from mytransformers.parallel.pipeline_parallel.layers import (PipeBoundaryPointModule, PipeFakeModule, PipeModule,
                                                              PipeRole,
                                                              StrategyModule,
                                                              FakeModule)
...
class BoundaryPointModuleGenerator(PipeGenerator):
    """
    генератор, для модуля граничной точки стадии. На нужных ппроцессах создает модуль крайней точки, на остальных - фейковый

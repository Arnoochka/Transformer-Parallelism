...
class OPTGenerator(ParallelModuleGenerator):
    ...
    def __new__(cls,
        ...
        fake_modules = OPTGenerator.get_fake_modules(num_layers)
        ...
        StageGenerator(modules, inner_boundary_points, cls.groups_info, inner_strategies, cls.bcast_groups, bcast_stretegies)

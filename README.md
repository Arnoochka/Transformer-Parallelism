...
1) Встроить MoE слой (dp версию) как-то в конвейер
2) Попытаться разработать s-MoE (сначала просто разделению в dp, затем еще попытаться добавить разделение экспертов на кластеры)
3) Проверить гипотезу сжатия - разжатия

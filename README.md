...
Оптимизация производительности распределённого инференса больших языковых моделей с архитектурой Mixture of Experts за счёт совершенствования механизмов параллелизма и коммуникации

Повышение эффективности распределённого инференса больших языковых моделей с архитектурой Mixture of Experts посредством оптимизации механизмов параллелизма, коммуникации и управления вычислительными ресурсами

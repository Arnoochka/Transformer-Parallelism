from mytransformers.parallel.pipeline_parallel_2.layers import (FakeModule, InnerStrategyModule, FinalStrategyModule)
...
from mytransformers.parallel.pipeline_parallel_2.pipeline import Pipeline
...
class PipelineGenerator(ParallelModuleGenerator):
    ...
    def get_stage(modules: List[Tuple[str, Module, FakeModule]],
                  ...
                  inner_strategies: List[InnerStrategyModule]) -> ModuleDict:
        """
